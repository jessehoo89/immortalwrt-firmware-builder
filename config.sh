...
# LuCI 主题和工具
PACKAGES_LUCI="luci-app-argon-config luci-app-autoreboot luci-app-msd_lite luci-app-wol luci-app-mosdns"
...
# 国际化包
PACKAGES_I18N="luci-i18n-zerotier-zh-cn luci-i18n-autoreboot-zh-cn luci-i18n-wol-zh-cn luci-i18n-msd_lite-zh-cn luci-i18n-upnp-zh-cn luci-i18n-diskman-zh-cn luci-i18n-argon-config-zh-cn luci-i18n-firewall-zh-cn luci-i18n-package-manager-zh-cn luci-i18n-lucky-zh-cn luci-i18n-mosdns-zh-cn"
