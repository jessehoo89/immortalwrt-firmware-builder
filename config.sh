...
# LuCI 主题和工具
# 注意: luci-app-mosdns 不在官方源，由 sbwml/luci-app-mosdns 仓库提供（见第三方软件版本配置）
...
# 国际化包
# 注意: luci-i18n-mosdns-zh-cn 由 sbwml/luci-app-mosdns 仓库提供（见第三方软件版本配置）
...
# SDK 版本自动判断: apk(25.x+) -> 25.12, ipk(24.x) -> 24.10
MOSDNS_TAG=""
